class X extends HTMLElement {
  ...
  async connectedCallback(){
    ...
    try{ const r=await window.passio.invoke("today",{}); if(!r.hits?.length){ el.remove(); return; } el.textContent = "🎂 " + r.hits.join(", "); }catch(e){ el.textContent="⚠"; }
  }
}
customElements.define("birthdays-chip",X);
