class X extends HTMLElement {
  ...
  async connectedCallback(){
    ...
    try{ const r=await window.passio.invoke("now",{}); if(!r.track){ el.remove(); return; } el.textContent = "♫ " + r.track.title.slice(0,24); }catch(e){ el.textContent="⚠"; }
  }
}
customElements.define("spotify-chip",X);
