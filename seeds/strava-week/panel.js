class X extends HTMLElement {
  ...
  async connectedCallback(){
    ...
    try{ const r=await window.passio.invoke("week",{}); if(r.km==null){ el.remove(); return; } el.textContent = "🏃 " + r.km + "km"; }catch(e){ el.textContent="⚠"; }
  }
}
customElements.define("strava-chip",X);
